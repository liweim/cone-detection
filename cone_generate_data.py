...
def generate_data(annotation_path, data_path, no_resize):
    if no_resize:
        PATCH_SIZE = 25
        resize_rate = 0.5
        factor0 = 8
...
if __name__ == '__main__':
    ...
    generate_data(annotation_path = args.annotation_path, data_path = args.data_path, no_resize = args.no_resize)
