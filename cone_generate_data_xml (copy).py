...
def data_augmentation(x, y, max_pixel):

    #random shift
    x_ = x + random.choice(range(-max_pixel, max_pixel))
    y_ = y + random.choice(range(-max_pixel, max_pixel))
    return x_, y_
